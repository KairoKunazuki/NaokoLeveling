...
exports.default = new forgescript_1.NativeFunction({
    name: '$getStatExp',
    description: 'Returns the experience points of target stat information',
    version: '0.0.1',
    brackets: true,
    unwrap: true,
    args: [
    ...
    async execute(ctx, [target, region, regionId]) {
        ...
        return forgescript_1.Return.success(await stat.getExp(stat.keyStat(region, regionId)));
    }
});
